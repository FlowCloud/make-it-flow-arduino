 ...
 */
public class GetLogRequest extends AbstractRequest<DeviceLog, Void> {

  public GetLogRequest(Context appContext) {
    super(DeviceLog.class, appContext, "/activity_log.cgi?output=xml", RequestType.get, null);
  }


  public String createCacheKey() {
    return GetLogRequest.class.toString();
  }
}
