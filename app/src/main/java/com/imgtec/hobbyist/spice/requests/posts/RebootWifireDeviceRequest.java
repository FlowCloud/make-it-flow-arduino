 ...
 */
public class RebootWifireDeviceRequest extends AbstractRequest<EmptyResponse, Void> {

  public RebootWifireDeviceRequest(Context appContext) {
    super(EmptyResponse.class, appContext, "/reboot.cgi", RequestType.post, null);
  }

  @Override
  public String createCacheKey() {
    return RebootWifireDeviceRequest.class.toString();
  }
}
