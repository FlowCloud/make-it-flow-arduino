 ...
 */
public class GetLogConfigRequest extends AbstractRequest<LoggingConfig, Void> {

  public GetLogConfigRequest(Context appContext) {
    super(LoggingConfig.class, appContext, "/config_logging.cgi?output=xml", RequestType.get, null);
  }

  @Override
  public String createCacheKey() {
    return GetLogConfigRequest.class.toString();
  }
}
