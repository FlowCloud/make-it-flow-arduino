...
public class TourConfigureFragment extends Fragment {

  private Button skipTourButton;

  public static Fragment newInstance() {
    return new TourConfigureFragment();
  }

  @Override
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    return inflater.inflate(R.layout.frag_tour_configure, container, false);
  }
