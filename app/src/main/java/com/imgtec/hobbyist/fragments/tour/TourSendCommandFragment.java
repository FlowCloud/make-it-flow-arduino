...
public class TourSendCommandFragment extends Fragment {

  private Button letsGetStarted;

  public static Fragment newInstance() {
    return new TourSendCommandFragment();
  }

  @Override
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    return inflater.inflate(R.layout.frag_tour_interact, container, false);
  }

  @Override
  public void onViewCreated(View view, Bundle savedInstanceState) {
    super.onViewCreated(view, savedInstanceState);
    letsGetStarted = (Button) view.findViewById(R.id.letsGetStarted);
